...
class Game():
    ...
    def load_data(self):
        ...
        if getattr(sys, 'frozen', False):
            ...
            self.game_folder = os.path.dirname(os.path.realpath(__file__))

        self.folder_main = path.join(self.game_folder, "Files")
    ...
    def checkLevel(self):
        ...
        if (self.spawning):
            if (self.level == 1):
                ...
                elif (self.spawnDelay(5000)):
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(11000)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(19000)):
                ...
                elif (self.spawnDelay(12000)):
                    spawnMob(self, "rotor", "left")
                elif (self.spawnDelay(20000)):
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(25500)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "guard", "right")
                elif (self.spawnDelay(30000)):
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(36000)):
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(40000)):
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(47000)):
                    spawnMob(self, "laser", "left")
                elif (self.spawnDelay(59000)):
                ...
                if (self.spawnDelay(0)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "guard", "right")
                elif (self.spawnDelay(6500)):
                    spawnMob(self, "rotor", "right")
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(12500)):
                    spawnMob(self, "rotor", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(23500)):
                    spawnMob(self, "guard", "left")
                    spawnMob(self, "guard", "right")
                elif (self.spawnDelay(30000)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(36500)):
                    spawnMob(self, "head", "right")
                    spawnMob(self, "rotor", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(40000)):
                ...
                if (self.spawnDelay(0)):
                    ...
                    spawnMob(self, "guard", "left")
                elif (self.spawnDelay(11500)):
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                elif (self.spawnDelay(15000)):
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(21000)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "guard", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(27000)):
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(35000)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "guard", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(40000)):
                ...
                if (self.spawnDelay(0)):
                    ...
                    spawnMob(self, "rotor", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(21500)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(28000)):
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                    spawnMob(self, "guard", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(33000)):
                    spawnMob(self, "head", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(37000)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                    spawnMob(self, "guard", "left")
                elif (self.spawnDelay(49000)):
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(57500)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(66000)):
                    spawnMob(self, "guard", "left")
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                ...
                if (self.spawnDelay(0)):
                    ...
                    spawnMob(self, "rotor", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(5250)):
                    spawnMob(self, "guard", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(10500)):
                    spawnMob(self, "guard", "right")
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(16000)):
                    spawnMob(self, "rotor", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(19000)):
                    spawnMob(self, "guard", "left")
                    ...
                    self.spawnLaserMob()
                elif (self.spawnDelay(46000)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(52500)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "rotor", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(56000)):
                    spawnMob(self, "rotor", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(70000)):
                    spawnMob(self, "guard", "right")
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                    # Up to 220000
                ...
                if (self.spawnDelay(0)):
                    ...
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                elif (self.spawnDelay(6600)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(16500)):
                    spawnMob(self, "rotor", "right")
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(21000)):
                    spawnMob(self, "guard", "left")
                    spawnMob(self, "guard", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(26500)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(31500)):
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                    spawnMob(self, "head", "left")
                    self.spawnLaserMob()
                    ...
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(58500)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                    spawnMob(self, "guard", "left")
                elif (self.spawnDelay(64000)):
                    spawnMob(self, "guard", "right")
                    spawnMob(self, "rotor", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(72000)):
                    spawnMob(self, "guard", "left")
                    spawnMob(self, "guard", "right")
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(77000)):
                    spawnMob(self, "head", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(84500)):
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                    # Up to 320000
                    self.spawning = False  # End level
                ...
                if (self.spawnDelay(0)):
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(1500)):
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(3200)):
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(7500)):
                    spawnMob(self, "rotor", "right")
                elif (self.spawnDelay(8800)):
                    spawnMob(self, "guard", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(12000)):
                    spawnMob(self, "head", "right")
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(13500)):
                    spawnMob(self, "guard", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(17000)):
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "guard", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(31500)):
                    ...
                    spawnMob(self, "rotor", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(34000)):
                    spawnMob(self, "guard", "left")
                    spawnMob(self, "rotor", "right")
                elif (self.spawnDelay(43000)):
                    spawnMob(self, "guard", "right")
                    spawnMob(self, "head", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(48000)):
                    spawnMob(self, "guard", "left")
                    spawnMob(self, "guard", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(67500)):
                    spawnMob(self, "head", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(49500)):
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "head", "right")
                elif (self.spawnDelay(56500)):
                    spawnMob(self, "head", "right")
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                    spawnMob(self, "guard", "left")
                elif (self.spawnDelay(61500)):
                    self.spawnLaserMob()
                ...
                if (self.spawnDelay(0)):
                    ...
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(62500)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(71500)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                    spawnMob(self, "guard", "left")
                elif (self.spawnDelay(84000)):
                    spawnMob(self, "head", "left")
                    spawnMob(self, "head", "right")
                    self.spawnLaserMob()
                elif (self.spawnDelay(88000)):
                    spawnMob(self, "rotor", "left")
                    self.spawnLaserMob()
                elif (self.spawnDelay(91500)):
                    spawnMob(self, "guard", "right")
                    spawnMob(self, "head", "left")
                elif (self.spawnDelay(105000)):
                    spawnMob(self, "rotor", "left")
                    spawnMob(self, "rotor", "right")
                    spawnMob(self, "guard", "left")
                    spawnMob(self, "head", "right")
